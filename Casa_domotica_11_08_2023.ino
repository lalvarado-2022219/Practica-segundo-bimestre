...
if(usuario==0)
{
//En caso de que el usuario sea 0, enciendo el led color ***, y apago el led color ***.
...
{
//En caso de que la contraseña sea correcta, enciendo el led color ***, y apago el led color ***.
...
//En caso de que la contraseña sea incorrecta, enciendo el led color ***, y apago el led color ***.
digitalWrite(led,LOW);
